          ...
          <div style={{ marginTop: '1em' }}>
            <label>
              ...
              <Input
                type="text"
                name="host"
                placeholder="http://your-fpv-host"
                value={settings.fpv.host}
          ...
          <div style={{ marginTop: '1em' }}>
            <label>
              ...
              <input
                ...
                min="1"
                max="12"
                defaultValue={hasCacheValue(cameraSettings) ? cameraSettings.value.framesize.toFixed() : '8'}
          ...
          <div style={{ marginTop: '1em' }}>
            <label>
              ...
              <input
                ...
                min="1"
                max="100"
                defaultValue={hasCacheValue(cameraSettings) ? cameraSettings.value.quality.toFixed() : '8'}
                style={{ marginLeft: '1em' }}
                name="quality"
              />
            </label>
          </div>
          <Button type="submit" style={{ marginTop: '2em' }} variant="contained" color="primary">
            Save FPV Settings
          </Button>
        </Paper>
      </Form>
